...
exports.verifyMagicLinkToken = exports.generateMagicLinkToken = exports.verifyRefreshToken = exports.verifyAccessToken = exports.generateTokens = void 0;
...
const generateMagicLinkToken = (email) => {
    return jsonwebtoken_1.default.sign({ email }, MAGIC_LINK_SECRET, { expiresIn: '15m' });
};
exports.generateMagicLinkToken = generateMagicLinkToken;
const verifyMagicLinkToken = (token) => {
    return jsonwebtoken_1.default.verify(token, MAGIC_LINK_SECRET);
};
